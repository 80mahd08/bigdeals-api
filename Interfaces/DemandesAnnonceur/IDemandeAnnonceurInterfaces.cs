...
public interface IDemandeAnnonceurService
{
    ...
    Task<(IReadOnlyList<DemandeAnnonceurDto> Items, int TotalCount)> GetAllRequestsPagedAsync(int pageNumber, int pageSize, int? statut, string? search, string? sortByDateDemande = null, string? sortByDateTraitement = null);
...
public interface IDemandeAnnonceurRepository
{
    ...
    Task<IReadOnlyList<DemandeAnnonceur>> GetAllPagedAsync(int pageNumber, int pageSize, int? statut, string? search, string? sortByDateDemande = null, string? sortByDateTraitement = null);
